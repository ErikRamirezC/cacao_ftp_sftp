...
dst_moves = 'C:/Users/LuisErikRamírez/Documents/python/Ejercicios/Ejemplo real/Carpeta dos/Finanzas/Reportes Operativos/DA_files'
        ...
        if i<=9:
            ...
            if os.path.isdir('C:/Users/LuisErikRamírez/Documents/python/Ejercicios/Ejemplo real/Carpeta dos/Finanzas/Reportes Operativos/DA_files/{0}/'.format(name_folder)):
                ...
                for file in glob.iglob(pattern, recursive=True):
                    ...
                    shutil.copy(file, 'C:/Users/LuisErikRamírez/Documents/python/Ejercicios/Ejemplo real/Carpeta dos/Finanzas/Reportes Operativos/DA_files/{0}/'.format(name_folder))
                    print('Copiando:', file)
            else:
